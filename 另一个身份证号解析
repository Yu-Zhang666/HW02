...
def Message(idcard):
  print('年龄:',2019-int(idcard[6:10]))
  print('性别:','女' if int(idcard[-2])%2==0 else '男')
  print('生日:',idcard[6:14])
if __name__ == "__main__": 
  ...
  idcard=input('input your idcard:')
  print(checkIdcard(idcard))
  if checkIdcard(idcard):
    print("省份：{}".format(area[idcard[0:2]] ))
    Message(idcard)
